...
export const BiWeeklyCalendar: React.FC<BiWeeklyCalendarProps> = ({ currentDate, tasks, onTaskClick }) => {
  const days = useMemo(() => {
  ...
  return (
    <div style={{ backgroundColor: '#F3F4F6', borderRadius: '8px', border: '1px solid #E5E7EB', overflow: 'hidden', display: 'flex', flexDirection: 'column', height: '100%' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(7, 1fr)', gridTemplateRows: '1fr 1fr', flex: 1, gap: '1px', backgroundColor: '#F3F4F6' }}>
        {days.map((date, i) => {
